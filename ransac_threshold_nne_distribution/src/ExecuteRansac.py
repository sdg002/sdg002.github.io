...
def run_ransac_on_single_image(inputfilepath:str,outputfolder:str,max_lines_to_find:int,threshold_factor:float):
    print("-----------------------------------------")
    print(f"Going to run RANSAC with threshold_factor {threshold_factor} on the file {inputfilepath}")
...
def main():
    ###
    #Use the following only when you want to run a single set of input images for the purpose of test
    ...
    matching_files=glob.glob(output_folder+"/**/*input*.csv",recursive=True)
